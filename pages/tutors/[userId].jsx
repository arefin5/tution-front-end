                  ...
                  <div>
                    <div className="md:mb-20">
                      ...
                      <div
                        ...
                        className="absolute left-1/2 md:left-[200px] transform -translate-x-1/2 flex items-center ml-2 justify-center w-32 h-32 md:w-48 md:h-48 bg-white rounded-full border-4 border-white"
                      >
                        <img
                          src={profileImg}
                          alt="Profile image"
                    ...
                    <div className="flex flex-row md:flex-col">
                      ...
                      <div  className="flex flex-col md:flex-row w-full items-center justify-between sm:w-full md:w-full mb-2 md:mb-0 mt-5 md:mt-0">
                        {/* icons */}
                        <div className="">
                          <p className="font-semibold text-gray-800 dark:text-gray-200 text-xl md:text-3xl flex items-center mt-4 md:mt-0 ">
                            {userName}
