          ...
          <ul className="flex mb-0 list-none pt-3 pb-4 flex-row" role="tablist">
            <li className="flex-auto text-center">
              <a
                className={
                  "text-md font-semibold px-1 md:px-5 block leading-normal " +
                  (openTab === 1 ? "text-green-500 activeB" : "text-black")
                }
                onClick={(e) => {
                  e.preventDefault();
                  setOpenTab(1);
            ...
            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
              <a
                className={
                  "text-md font-semibold px-1 md:px-5 block leading-normal " +
                  (openTab === 2 ? "text-green-500 activeB" : "text-black")
                }
                onClick={(e) => {
                  e.preventDefault();
                  setOpenTab(2);
            ...
            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
              <a
                className={
                  "text-md font-semibold px-1 md:px-5 block leading-normal " +
                  (openTab === 3 ? "text-green-500 activeB" : "text-black")
                }
                onClick={(e) => {
                  e.preventDefault();
                  setOpenTab(3);
            ...
            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center">
              <a
                className={
                  "text-md font-semibold px-1 md:px-5 block leading-normal " +
                  (openTab === 4 ? "text-green-500 activeB" : "text-black")
                }
                onClick={(e) => {
                  e.preventDefault();
                  setOpenTab(4);
