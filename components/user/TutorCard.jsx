...
// //     <div className="flex flex-col  tu-c
// //     items-center relative text-rose-600
// //      bg-white 
// //      dark:bg-neutral-800 rounded-xl
// //      tutor-cards
...
//   return (
//     <Squircle >
//       <div className="tu-card items-center relative 
//       text-rose-600 bg-white dark:bg-neutral-800 rounded-xl 
//       tutor-cards p-4 lg:p-8 border transition duration-300">
//         <Link href={`/tutors/${id}`}>
//           <a>
...
// // The parent component that uses TutorCard
