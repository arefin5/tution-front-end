...
// // // //         <h1 className="text-4xl font-bold mb-4 baneer-f">দেশের সবচাইতে বড় টিউটর প্ল্যাটফর্মে স্বাগতম!</h1>
// // // //         <p className="text-xl opacity-50 baneer-f">সেরা শিক্ষকদের পরিচর্যায় দেশের যেকোন প্রান্ত থেকে<br />অব্যাহত থাকুক পড়াশুনার অগ্রযাত্রা</p>
// // // //         <div className="bg-white mt-4 w-full max-w-xl flex flex-col md:flex-row pt-4 pb-4 pl-6 pr-6 rounded-lg">
// // // //           <div className="flex-grow relative bg-white rounded-lg order-2 md:order-1 md:mr-1 mt-2 md:mt-0">
// // // //             <HiOutlineLocationMarker className="absolute top-1/2 transform -translate-y-1/2 left-2 text-gray-600" />
// // // //             <input
// // // //               type="text"
// // // //               placeholder="Select Location"
...
// // // //             />
// // // //           </div>
// // // //           <div className="flex-grow relative bg-white rounded-lg order-1 md:order-2">
// // // //             <BiSearch className="absolute top-1/2 transform -translate-y-1/2 left-2 text-gray-600" />
// // // //             <input
// // // //               type="text"
// // // //               placeholder="Search by dept, institute"
...
// // // //           <button
// // // //             onClick={handleSearch}
// // // //             className="bg-green-500 text-white rounded-lg px-6 py-1 ml-2 mt-2 md:mt-0 whitespace-nowrap h-12"
// // // //           >
// // // //             Search Tutor
// // // //           </button>
// // // //         </div>
...
// // //         <p className="text-xl opacity-50 baneer-f">সেরা শিক্ষকদের পরিচর্যায় দেশের যেকোন প্রান্ত থেকে<br />অব্যাহত থাকুক পড়াশুনার অগ্রযাত্রা</p>
// // //         <div className="bg-white mt-4 w-full max-w-xl flex pt-4 pb-4 pl-6 pr-6 rounded-lg">
// // //           <div className="flex-grow relative bg-white rounded-lg order-2 md:order-1">
// // //             <HiOutlineLocationMarker className="absolute top-1/2 transform -translate-y-1/2 left-2 text-gray-600" />
// // //             <input
// // //               type="text"
// // //               placeholder="Select Location"
...
// // //             />
// // //           </div>
// // //           <div className="flex-grow relative bg-white rounded-lg order-1 md:order-2 ml-1">
// // //             <BiSearch className="absolute top-1/2 transform -translate-y-1/2 left-2 text-gray-600" />
// // //             <input
// // //               type="text"
// // //               placeholder="Search by dept, institute"
...
// // //           <button
// // //             onClick={handleSearch}
// // //             className="bg-green-500 text-white rounded-lg px-6 py-1 ml-2 whitespace-nowrap h-12 order-3"
// // //           >
// // //             Search Tutor
// // //           </button>
// // //         </div>
...
// //           <div className="flex-grow relative bg-white rounded-lg order-2 lg:order-1 mt-2 lg:mt-0">
// //             <HiOutlineLocationMarker className="absolute top-1/2 transform -translate-y-1/2 left-2 text-gray-600" />
// //             <input
// //               type="text"
// //               placeholder="Select Location"
...
// //             />
// //           </div>
// //           <div className="flex-grow relative bg-white rounded-lg order-1 lg:order-2 mt-2 lg:mt-0">
// //             <BiSearch className="absolute top-1/2 transform -translate-y-1/2 left-2 text-gray-600" />
// //             <input
// //               type="text"
// //               placeholder="Search by dept, institute"
...
// //           <button
// //             onClick={handleSearch}
// //             className="bg-green-500 text-white rounded-lg px-6 py-1 mt-2 lg:mt-0 lg:ml-2 whitespace-nowrap h-12 order-3 lg:order-3"
// //           >
// //             Search Tutor
// //           </button>
// //         </div>
...
//           <button
//             onClick={handleSearch}
//             className="bg-green-500 text-white rounded-lg px-6 py-1 mt-2 lg:mt-0 lg:ml-2 whitespace-nowrap h-12 order-3"
//           >
//             Search Tutor
//           </button>
//         </div>
