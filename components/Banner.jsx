...
// //             className="bg-green-500 text-white rounded-lg px-6 ml-2"
// //           >
// //             Search Tutor
// //           </button>
// //         </div>
...
//               type="text"
//               placeholder="Select Location"
//               className="w-full pl-10 pr-3 py-4 border border-gray-300 focus:outline-none  rounded-lg"
//               value={location}
//               onChange={(e) => setLocation(e.target.value)}
//             />
//           </div>
//           <div className="flex-grow relative bg-white rounded-r-lg">
//             <BiSearch className="absolute top-2 left-2 text-gray-600" />
//             <input
//               type="text"
//               placeholder="Search by dept, institute"
//               className="w-full pl-10 pr-3 py-4 ml-1 rounded-lg border border-gray-300 focus:outline-none"
//               value={search}
//               onChange={(e) => setSearch(e.target.value)}
//             />
//             {search && (
...
//           <button
//             onClick={handleSearch}
//             className="bg-green-500 text-white rounded-lg px-6 py-1 ml-2 whitespace-nowrap"
//           >
//             Search Tutor
//           </button>
//         </div>
